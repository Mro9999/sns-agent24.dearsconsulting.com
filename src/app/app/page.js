        ...
        const varietyAngles = [
            {
                ...
                avoid: "「売上達成後の虚しさ」「経営者の心理」「100年後」「未来の自分」のような哲学・心理寄りのテーマ"
            },
            {
                theme: "業界トレンド・データ分析",
                guidance: "数値・統計・最新動向を用いた客観的な業界解説。具体的な数字や事実ベースで語る。",
                avoid: "情緒的な表現、「あなたの心は」「本当の願い」のような内省系のフレーズ"
            },
            {
                theme: "顧客の現場課題と解決策",
                guidance: "顧客が日々ぶつかる具体的な業務課題（人材、集客手法、業務効率、ツール選定 等）と実践的解決策。",
                avoid: "「売上目標の先」「達成しても満たされない」のような抽象的悩み"
            },
            {
                theme: "業界用語・専門知識の解説",
            ...
            },
            {
                ...
                guidance: "朝のルーティン、読書、業界外の趣味、健康習慣、対話のエピソード等の親しみやすい話題。",
